...
import userImg from "../public/logos/omnifuse_logo_light.PNG";
import logoImg from "../public/logos/onmifuse_logo.PNG";
        ...
        >
          ...
          {theme == "dark" ? (
            <span className="text-xl font-bold text-[var(--text-main)] tracking-tight">
              <Image src={logoImg} alt="My photo" width={100} height={90} />
            </span>
          ) : (
            <span className="text-xl font-bold text-[var(--text-main)] tracking-tight">
              <Image src={userImg} alt="My photos" width={100} height={90} />
            </span>
          )}
        </div>
